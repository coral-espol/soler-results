...
class RobotDataProcessor:
    ...
    def plot_performance_boxplot(self, window_sec: int = 1000, max_time_sec: int = 10000, save_path: Optional[str] = None) -> None:
        ...
        ax.set_xlabel("Time (s)", fontsize=20, fontweight='bold', labelpad=15)
...
def main():
    ...
    csv_path = r"/home/gmadro/soler_experiment/experiment_data.csv"
    output_dir = r"/home/gmadro/soler_experiment/processing_data"
