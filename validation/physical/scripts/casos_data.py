...
# === Parámetros Globales ===
# Los logs reales ya están en segundos (a diferencia de los ticks de simulación
# a 10/s), así que no se divide dos veces.
T_TICKS_PER_SEC = 1.0
WINDOW_SEC = 60
MAX_TIME_SEC = 600
...
def load_and_merge_data() -> pd.DataFrame:
    """Recorre las carpetas case1..case3, lee los CSV procesados y los combina."""
    all_data = []

    for i in range(1, 4):
        caso_name = f"case{i}"
        csv_path = BASE_DIR / caso_name / "processed" / "experiment_data.csv"
